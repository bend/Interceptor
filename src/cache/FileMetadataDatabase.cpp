...
std::string FileMetadataDatabase::lastModified(const std::string& filename) const
{
...
void FileMetadataDatabase::setETag(const std::string& filename, const std::string& eTag)
{
